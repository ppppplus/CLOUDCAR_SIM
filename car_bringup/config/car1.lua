...
options = {
  ...
  map_frame = "RMP_1/map",
  tracking_frame = "RMP_1/imu_link", -- imu_link, If you are using gazebo, use 'base_footprint' (libgazebo_ros_imu's bug)
  published_frame = "RMP_1/odom",
  odom_frame = "RMP_1/odom",
